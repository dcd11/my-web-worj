    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mb-4">
            <div class="entry2">
              <a href="single.php"><img src="images/img_2.jpg" alt="Image" class="img-fluid rounded"></a>
              <div class="excerpt">
          ...
          <div class="col-lg-4 mb-4">
            <div class="entry2">
              <a href="single.php"><img src="images/img_3.jpg" alt="Image" class="img-fluid rounded"></a>
              <div class="excerpt">
          ...
          <div class="col-lg-4 mb-4">
            <div class="entry2">
              <a href="single.php"><img src="images/img_4.jpg" alt="Image" class="img-fluid rounded"></a>
              <div class="excerpt">
      ...
      <div class="container">
        ...
        <div class="row align-items-stretch retro-layout">
          ...
          <div class="col-md-5 order-md-2">
            <a href="single.php" class="hentry img-1 h-100 gradient" style="background-image: url('images/img_4.jpg');">
          ...
          <div class="col-md-7">
            ...
            <a href="single.php" class="hentry img-2 v-height mb30 gradient" style="background-image: url('images/img_1.jpg');">
            ...
            <div class="two-col d-block d-md-flex">
              <a href="single.php" class="hentry v-height img-2 gradient" style="background-image: url('images/img_2.jpg');">
              ...
              <a href="single.php" class="hentry v-height img-2 ml-auto gradient" style="background-image: url('images/img_3.jpg');">
...
<?php require './components/subscribe_form.php'?>
